...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light fixed-top">
        ...
        <div id="my-nav" class="collapse navbar-collapse">
            <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link active" href="politica.php"> Politica de Compra</a>
                </li>
                <li class="nav-item">
    ...
    <div class="text-center">
        <h1 class="display-6">Política de Compra</h1>
        <hr class="my-4">
        <p class="lead">Compra</p>
            <p>"Cómics solamente Digitales"</p>
            <hr class="my-4">
            <br>
        <p class="lead">Pagos</p>
            ...
            <hr class="my-4">
            <br>
        <p class="lead">Envíos y Devoluciones</p>
            <p> "No hay envíos, descrgas digitales.</p>
            <p> "30 minutos a partir del pago."</p>
            <hr class="my-4">
            <br>
