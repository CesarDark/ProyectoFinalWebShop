                        ...
                        <div class="card-body">
                            <form name="login" action="archivos_sesion/login.php" method="post">
                                ...
                                <div class="md-form">
                                    ...
                                    <input type="text" name="usuario" id="defaultForm-email" class="form-control" required>
                    ...
                    <div class="card bg-light text-dark">
                        <div class="card-body">
                            <form name="alta" action="archivos_sesion/alta.php" method="post">
                                <h2 class="text-center font-up font-bold py-4">Registrate:</h2>
                                <div class="md-form">
                                    <i class="fa fa-user prefix grey-text"></i>
                                    <input type="text" name="nombre" id="orangeForm-name3" class="form-control" required>
                                    <label for="orangeForm-name3">Tú Nombre:</label>
                                </div>
                                <div class="md-form">
                                    <i class="fa fa-user prefix grey-text"></i>
                                    <input type="text" name="apaterno" id="orangeForm-name3" class="form-control" required>
                                    <label for="orangeForm-name3">Tú Apellido:</label>
                                </div>
                                <div class="md-form">
                                    <i class="fa fa-user prefix grey-text"></i>
                                    <input type="text" name="usuario" id="orangeForm-name3" class="form-control" required>
                                    <label for="orangeForm-name3">Tú Usuario:</label>
                                </div>
                                <div class="md-form">
                                    <i class="fa fa-envelope prefix grey-text"></i>
                                    <input type="email" name="email" id="orangeForm-email3" class="form-control" required>
                                ...
                                <div class="text-center">
                                    <button class="btn btn-dark">Registrar<i class="fa fa-angle-double-right pl-2" aria-hidden="true"></i></button>
                                </div>
                            </form>
                        </div>
                    </div>
